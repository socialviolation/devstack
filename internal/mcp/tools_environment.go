...
func registerEnvironmentTool(mcpServer *server.MCPServer, obsURL, workspaceName, workspacePath, defaultService string, ws *workspace.Workspace) {
	...
	mcpServer.AddTool(tool, func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		tools := []string{"status", "start", "restart", "stop", "topology", "configure", "process_logs", "service_env", "base", "observability", "hooks", "migrate", "stack_create", "stack_add", "stack_list", "stack_config", "stack_note", "stack_up", "stack_down", "stack_rm", "env_use", "env_which", "env_set"}
		if otelOn {
